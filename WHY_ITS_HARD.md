...
## 9. The second open piece: uniformization (W2')
...
## 10. The meta-story: what this project actually is
...
## 11. The one-paragraph summary for the person in a hurry
...
crowd-width, and crowds don't add depth. The project has machine-verified
everything *except* that one bounded-crowd fact, stated it precisely, and
gathered real evidence it's true. Whether it *is* true is the open problem;
that we now know it's the *only* open problem is the achievement.
