...
> *Historical:* the **summary table of all eleven approaches** (five "promising and partially successful", seven "disproved, retracted, or incomplete") is preserved in [OUTDATED.md](OUTDATED.md). The current pillar is the cover-tree tableau / split-forest route, summarised above; everything else is either subsumed (two-tier quotient for the PO-coherent fragment) or superseded.
