...
- [**`decidability_ALCIRCC5.pdf`**](https://github.com/lambdamikel/alcircc5/blob/master/papers/decidability_ALCIRCC5.pdf) -- **Retracted/superseded**: earlier quasimodel approach (22 pages). The current decidability argument rests on GPT-5.4's v1 split-forest paper plus GPT-5.5's [repaired split-forest decidability proof](https://github.com/lambdamikel/alcircc5/blob/master/papers/gpt5.5_round2/repaired_split_forest_no_automata_proof.pdf); this paper's reasoner is retained only as a cross-validation oracle (see the Reasoners section above).
- [**`decidability_ALCIRCC5.tex`**](https://github.com/lambdamikel/alcircc5/blob/master/papers/decidability_ALCIRCC5.tex) -- LaTeX source for the retracted quasimodel paper
