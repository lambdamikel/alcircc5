...
- [`completeness_extraction_ALCIRCC5_v2.tex`](https://github.com/lambdamikel/alcircc5/blob/master/papers/completeness_extraction_ALCIRCC5_v2.tex) — Claude's completeness extraction v2 paper (29 pages, v2.1, May 2026, **current — completeness side**)
...
- [`papers/completeness_extraction_ALCIRCC5_v2.pdf`](https://github.com/lambdamikel/alcircc5/blob/master/papers/completeness_extraction_ALCIRCC5_v2.pdf) (29 pages, v2.1) — closes the model-to-quotient gap **without** ω-acceptance machinery, by reducing GPT-5.5's cycle-realization condition to finite-graph reachability.
...
- [`papers/completeness_extraction_ALCIRCC5_v2.pdf`](https://github.com/lambdamikel/alcircc5/blob/master/papers/completeness_extraction_ALCIRCC5_v2.pdf) — **v2 completeness extraction** (Claude, May 2026, 29 pages, v2.1). The model→quotient direction, with the seven repairs above. **Wholly supersedes** the v1 completeness extraction.
