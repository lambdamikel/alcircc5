...
**Result: 991 extension tests, zero failures across all 16 SAT concepts.** Previously, greedy witness selection caused 132 failures across 3 concepts; all resolved by sibling-compatible witness plans.
