...
\textit{sibling-interface paper~v2}~\cite{SiblingInterfaceV2}
(May~2026, 10~pages), which preserves Thms~1.17--1.19 (soundness)
verbatim and reinterprets Def~1.5 (parent self-loops, no ambient
root), Def~1.7 ($\PP/\PPI$ by reachability discharge), and Thm~1.20
(model-to-quotient delegated to the completeness-extraction~v2 paper
below).  \textit{Completeness extraction~v2}~\cite{CompletenessExtraction}
