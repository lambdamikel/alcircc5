...
regions in a topological space; weak-$\EQ$ semantics reduces to strong via
TBox internalization, so we fix strong $\EQ$ throughout. The decision
problem is: given $C_0$, is it satisfiable?
