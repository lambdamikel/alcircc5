...
and Reynolds and Zakharyaschev~\cite{ReynoldsZakharyaschev2001}.  They do not
...
\begin{proof}
  ...
  cannot force it---the composition table allows too many relations
...
\begin{enumerate}
  \item \textbf{``No results'':}
    ...
    for $\mathcal{ALC}_{\mathcal{RA}^\ominus}$ (ALC with role axioms in
    the non-disjoint-roles variant, via reduction from non-empty CFG
    intersection).  The uncited technical
