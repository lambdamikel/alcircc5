...
and eventuality obligations come for free.  This proof has \emph{not}
itself been cold-reviewed; promoting it is a strategic clarity move,
not a proof upgrade, and the overall status remains \emph{strongly
...
mechanically certified}.  Round-9 was the most developed statement of
the no-automata thread when written; it was superseded within the
day, as the next subsection records.
...
handle the brittle half directly.  The promotion is strategic, not a
proof upgrade; the automata proof has not itself been cold-reviewed,
so the natural next step is to cold-review it.
...
reduced to automaton-shaped lemmas.  The automata proof has not
itself been cold-reviewed or machine-certified.
...
\begin{enumerate}
  ...
  \item The \emph{GPT-5.5 split-forest $+$ parity-tree-automata
    proof}~\cite{GPT55AutomataRoute} (21~pages, \textbf{the primary
    statement since 29~May~2026}): the split-forest normal form
