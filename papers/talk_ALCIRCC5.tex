...
\begin{tikzpicture}[scale=.95]
  ...
  \node[warm,align=right,anchor=east,text width=3.3cm] at (-.35,-.95)
...
different reasoners, 23 years apart, identical result} (green = individuals;
note \emph{Hamburg} and \emph{Alster} each have \alert{two} parents --- the
DAG the reasoner must get right).}
\end{frame}
