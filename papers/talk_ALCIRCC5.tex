...
\emph{should} be one corner --- but the table allows \alert{six} relations
between them. Loose: the branches never join. Forced merge (isolation
markers): \emph{every} corner collapses to a point (re-verified 2026, depth
2, RCC5 \emph{and} RCC8).}
\medskip
