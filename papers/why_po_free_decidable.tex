...
still what the soundness half \emph{constructs}, it is the content of the
normal form that makes composition closure free, and it is what decided that a
signature should record vertical position. The idea's job changed --- from a
