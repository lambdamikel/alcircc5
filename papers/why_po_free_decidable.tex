...
Remaining for full certification: the model-of-$C_0$ layer (Hintikka
demand/universal satisfaction over the unfolding) and the completeness
extraction carrying the $K(C_0)$ bound. Until then, the honest label is
the project's standing one: \textbf{strongly supported, with the
soundness core machine-certified --- not certified end-to-end.}
