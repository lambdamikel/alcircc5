...
$\mathrm{Decidable}$ satisfiability. Still open: exactly that premise
--- the extraction carrying the $K(C_0)$ bound (round~D2 --- see
\code{LEAN.md}; its model-side core, the external-relation
stabilization theorem of \S\ref{ssec:crux} with both forcing
corollaries, is already kernel-checked). Until then, the honest label is the project's
