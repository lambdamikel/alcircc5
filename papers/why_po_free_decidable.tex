...
Remaining for full certification --- the campaign is underway
(round~A, 2026-07-22, landed the model-of-$C_0$ layer: a valid
single-kernel two-tier certificate now yields a model of the concept,
kernel-checked end to end): multi-kernel certificate formats
(round~B), an executable Boolean checker (round~C), and the
