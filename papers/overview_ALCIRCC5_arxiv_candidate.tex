...
\begin{itemize}
  ...
  \item \textbf{The problem reduced to one well-posed keystone.}  The
    ...
    question.
  \item \textbf{A certified local theory and a decidable fragment.}  The
    $\mathrm{RCC5}$ normal form is machine-certified
    (\texttt{formal/RCC5NormalForm.lean}); the $\forall\PO$-free /
    PO-coherent fragment is decidable~\cite{TwoTierQuotient}.
