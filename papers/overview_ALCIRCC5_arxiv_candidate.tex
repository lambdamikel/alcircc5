...
the long context can find.  This was confirmed four times on this
...
the automata route).  The reviewer-was-cold
...
was confirmed four times (April~2026, the cover-tree
...
produced round-10 and the switch to the automata route).  The cost is
one session; the pay-off is a list of concrete defects --- and, in the
...
sobering corollary, visible across all four instances, is that
...
which has not yet happened---the parity-tree-automata proof now the
primary statement has not itself been cold-reviewed.  The pattern is operationalisable
...
proof has not itself been cold-reviewed or machine-certified.  The
