...
finite-representation keystone gap and was repaired (the repaired proof
$+$ A/B/C companion; Theorem~B, finite abstraction adequacy, is the
load-bearing keystone), and that repair has not been cold-reviewed in
turn.  The overall status remains \emph{strongly supported, not
certified}.
...
and repaired---the repaired proof and its Theorem~B (finite abstraction
adequacy) are now the next target for cold review.
...
the long context can find.  This was confirmed five times on this
...
representatives and an A/B/C companion).  The reviewer-was-cold
...
was confirmed five times (April~2026, the cover-tree
...
representatives and an A/B/C companion).  The cost is one session; the pay-off is a list of concrete defects --- and, in the
...
sobering corollary, visible across all five instances, is that
...
which has not yet happened---the repaired automata proof and its
Theorem~B have not themselves been cold-reviewed.  The pattern is operationalisable
...
share the keystone gap, and repaired (the repaired proof $+$ A/B/C
companion), and that repair and its Theorem~B have not been
cold-reviewed or machine-certified.  The
