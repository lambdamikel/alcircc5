...
\item formalise the mathematical proofs (split-forest semantics,
  completeness extraction across eight review rounds, the
  round-7 pair-shape / incidence-tag architecture, and the
  round-8 saturated-side-context construction);
