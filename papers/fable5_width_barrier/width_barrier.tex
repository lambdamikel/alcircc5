...
finite codes are not wired into the checker, there is no global
inspected-domain coverage, and the non-vacuity witness
(\code{certK\_finitely\_codable}) is \emph{degenerate} (empty domain,
zero templates --- verified). \textbf{F4} also remains. Accordingly the
