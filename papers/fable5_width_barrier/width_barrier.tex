...
Decision-grade reduction: bounded checker $\Rightarrow$ \code{Decidable}
...
What remains is engineering rather than mathematics: wiring the finite
codes end-to-end into a single executable checker (a bounded-domain
decidability pass for the labelling). With the three interface findings
(F1--F3) thus discharged or reduced to routine wiring, the sole
substantive remainders are the mathematics F6 and W2$'$.
\end{remark}
