...
models have cover-tree structure with \textbf{zero genuine
counterexamples} across 11.4\,M enumerated models.  The results are
...
limited type sets.  Results:
\begin{itemize}[nosep]
  \item \textbf{765/768} SAT concepts (99.6\%) have at least one
    finite cover-tree model.
  \item \textbf{11.4\,M} total models enumerated, of which
    \textbf{8.36\,M} (73.3\%) have cover-tree structure.
  \item \textbf{Zero genuine counterexamples} --- every SAT concept
    tested has a finite cover-tree model (or had no models at
    tested domain sizes).
...
constraint being imposed, and 99.6\% of SAT concepts have finite
cover-tree models when the type pool is expanded (zero genuine
counterexamples across 11.4\,M enumerated models).
...
structure, with 765/768~SAT concepts (99.6\%) having finite
cover-tree models and zero genuine counterexamples across
11.4\,M enumerated models (Section~\ref{sec:decomposition}).
