...
reasoner~\cite{ClaudeDecidability}.  The results are
...
against an independent quasimodel-based reasoner, providing
computational evidence for the correctness of the split-forest
approach.  A formal correctness proof, complexity analysis, and
extension to $\ALCIRCC{8}$ remain open.
